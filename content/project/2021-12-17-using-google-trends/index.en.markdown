...
tags:
  ...
  - google
subtitle: ''
summary: 'Standardizing google trends data to see changes in interest across time'
authors: []
...
For example, if run a two query search for the topics below - "soy milk" and "almond milk" - I can see that almond milk is far more popular. 
...
We can see that plant based milk searches peak in January's as people make New Year's resolutions. Searches then decline by mid-Spring of the year. In 2020, searches stabilized to a pretty standard level, but there's been more volatility in 2021. Oat milk has had some large positive shifts in interest, while just about every other type of milk has seen declines in search interest in the last three quarters of the year. Since summer, only Oat milk and the general "plant based milk" searches have seen increasing interest (as well as Almond milk getting a little bump in the last part of the year.)
